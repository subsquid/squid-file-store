            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_6: Array<SchemaElement.SchemaElement> = new Array<SchemaElement.SchemaElement>();
                ...
                case 8:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_16: EncryptionAlgorithm.EncryptionAlgorithm = EncryptionAlgorithm.EncryptionAlgorithm.read(input);
                        _args.encryption_algorithm = value_16;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 9:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        ...
                        _args.footer_signing_key_metadata = value_17;
                    }
                    else {
                        input.skip(fieldType);
                    }
